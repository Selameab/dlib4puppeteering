...
int main(int argc, char **argv) {
    ...
    dlib::deserialize("/home/ss/shape_predictor_68_face_landmarks.dat") >> pose_model;
    
    ros::init(argc, argv, "dlib4puppeteering");
    ros::NodeHandle nh;
    pub = nh.advertise<std_msgs::String>("/blender_value/", 1000);
